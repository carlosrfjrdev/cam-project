# STACK-CAM-OFICIAL-LINUX

> **Projeto:** CaM — The Carlos Alternative Money
> **Documento:** Stack Oficial — **variante Linux + MetaTrader 5**
> **Versão:** 1.0
> **Data:** 2026-05-24
> **Status:** Proposta alternativa em paralelo a [`STACK-CAM-OFICIAL.md`](./STACK-CAM-OFICIAL.md) (variante Windows + Profit)
> **Decisão pendente:** Carlos vai escolher entre **Windows+Profit** OU **Linux+MT5** (ver §13 Matriz Comparativa ao final)
> **Vinculação constitucional:** [`../CONSTITUICAO.md`](../CONSTITUICAO.md)
> **Insumos:** mesma síntese do documento Windows + pesquisa específica sobre MT5/Linux
...
Carlos ainda não decidiu se opera em **Windows + Profit** ou **Linux + MT5**. Os dois documentos coexistem até a decisão. Quando Carlos decidir, o outro vira **archive**.

**Premissa fundadora desta variante:** SO produção = Linux (Ubuntu LTS), broker = **MetaTrader 5**, plataforma de execução automática = **MQL5 + Expert Advisors (EAs)**.
