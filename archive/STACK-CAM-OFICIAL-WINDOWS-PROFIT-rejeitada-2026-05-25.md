...
> **Decisão pendente:** Carlos vai escolher entre **esta variante (Windows+Profit)** OU a variante Linux+MT5 — matriz comparativa explícita está em `STACK-CAM-OFICIAL-LINUX.MD` §13. Instrumento formal de decisão: [`DECISION-MEMO-LINUX-OR-WINDOWS.md`](./DECISION-MEMO-LINUX-OR-WINDOWS.md)
