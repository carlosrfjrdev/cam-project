...
Luiz Barsi Filho — maior investidor pessoa física da B3, renda de dividendos, longo prazo.

## Identidade

- **Código:** `BARSI`
- **Cor:** `#065F46` (Verde Perene)
- **Ícone:** `TreePine`
- **Símbolo:** 🌳
- **Mundo:** Financeiro — ativos / patrimônio
- **Tom:** Paciente, longo prazo, renda de dividendos, "não é margem"
