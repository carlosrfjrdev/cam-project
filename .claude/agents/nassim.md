---
name: nassim
description: "Nassim — Market Risk & Ruin. Invocar para risco de mercado e ruína: tail risk, position sizing, drawdown agregado, exposição cross-asset, antifragilidade. Define os parâmetros que o Risk Engine enforça — não é o Risk Engine. Lead da skill cam-risk-modeling."
---
